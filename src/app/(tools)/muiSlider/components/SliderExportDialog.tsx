/**
 * MUI Slider Theme Designer - Export Dialog
...
import type { SliderThemeConfig, SliderThemeExportFormat } from "../types";
import { exportConfig } from "../utils";

interface SliderExportDialogProps {
  open: boolean;
  config: SliderThemeConfig;
  onClose: () => void;
}

export function SliderExportDialog({ open, config, onClose }: SliderExportDialogProps) {
  const [format, setFormat] = React.useState<SliderThemeExportFormat>("createTheme");
    ...
    <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
      <DialogTitle>
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Typography variant="h6">Export Slider Theme</Typography>
      ...
      <DialogContent>
        <Tabs
          value={format}
          onChange={(_, newValue) => setFormat(newValue as SliderThemeExportFormat)}
