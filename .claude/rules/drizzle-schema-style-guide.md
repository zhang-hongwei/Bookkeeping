...
alwaysApply: false
---
# Drizzle ORM Schema Style Guide for product-pilot-template

This document outlines the conventions and best practices for defining PostgreSQL Drizzle ORM schemas within the product-pilot-template project.
