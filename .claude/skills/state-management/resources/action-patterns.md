...
本文档详细说明了 Project 项目中 Zustand Action 的组织方式、命名规范和实现模式，特别关注乐观更新与后端服务的集成。

## Action 类型分层

Project 的 Action 采用分层架构，明确区分不同职责：
...
乐观更新是 Project 中的核心模式，用于提供流畅的用户体验：
